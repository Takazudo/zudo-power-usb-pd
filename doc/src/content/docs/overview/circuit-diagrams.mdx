...
This section documents the **STUSB4500-based** design (v1.1). The STUSB4500 is USB-IF certified with ~95%+ charger compatibility. For the deprecated CH224D design (v1.0), see [CH224D USB-PD Controller](../learning/ch224d-usb-pd-controller.md).
