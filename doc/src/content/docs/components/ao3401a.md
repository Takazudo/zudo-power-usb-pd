...
Operation (VBUS_EN_SNK is active-LOW, open-drain):
- VBUS_EN_SNK = Hi-Z (deasserted): Gate pulled HIGH by R1 → MOSFET OFF
- VBUS_EN_SNK = LOW (asserted, pulled): Gate pulled LOW through R2 → MOSFET ON
