...
Components:
- R7 (10kΩ) with C33 (22nF) in parallel: Creates pole-zero compensation (Type II)
- R8 (1kΩ): Sets feedback tap voltage
- C33 (22nF ceramic): Feedback compensation capacitor in parallel with R7
...
- **C33**: 22nF ceramic, 250V X7R (feedback compensation, parallel with R7)
