...
COMPONENTS = {
    ...
    'D6':  ('PESD24VS1UB_C85382', 'PESD24VS1UB', 'C85382', 'zudo-pd:SOD-523_L1.2-W0.8-LS1.6-RD', True, (228.6, 241.3)),
    'D7':  ('PESD24VS1UB_C85382', 'PESD24VS1UB', 'C85382', 'zudo-pd:SOD-523_L1.2-W0.8-LS1.6-RD', True, (266.7, 241.3)),
    ...
    'C2':  ('CC0805KRX7R9BB104', '100nF/50V', 'C1711', 'zudo-pd:C0805', False, (76.2, 165.1)),
    ...
    'C35': ('CC0805KRX7R9BB104', '100nF/50V', 'C1711', 'zudo-pd:C0805', False, (190.5, 165.1)),
    ...
    'TP1': ('TestPoint', 'TP_VBUS_OUT', '', 'TestPoint:TestPoint_Pad_D1.5mm', False, (355.6, 50.8)),
    'TP2': ('TestPoint', 'TP_GND', '', 'TestPoint:TestPoint_Pad_D1.5mm', False, (355.6, 76.2)),
    'TP6': ('TestPoint', 'TP_VBUS_VS_DISCH', '', 'TestPoint:TestPoint_Pad_D1.5mm', False, (355.6, 101.6)),
}
