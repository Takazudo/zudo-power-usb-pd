...
|------|----------|-------------|------|------------|--------|------|------|
| **U1** | **C3975094** | **CH224D** | USB PD Controller (5/9/12/15/20V) | QFN-20 | **2,291** | **$0.36** | PD交渉 (15V) |
...
| 記号 | 部品番号 | メーカー品番 | 説明 | パッケージ | 在庫数 | 価格 | 用途 |
|------|----------|-------------|------|------------|--------|------|------|
| **U6** | **C2914** | **L7812CV-DG** | +12V 1.5A | TO-220 | **158,795** | **$0.11** | +12V出力 |
| **U7** | **C86206** | **L7805ABD2T-TR** | +5V 1.5A | TO-263-2 | **272,379** | **$0.11** | +5V出力 |
| **U8** | **C94173** | **CJ7912** | -12V 1.5A | TO-252-2L | **3,386** | **$0.11** | -12V出力 |
...
**段階3小計: $0.37** (高在庫レギュレータ使用)

### 🛡️ 段階4: 保護回路（初心者対応・2段階保護）

#### PTCリセッタブルヒューズ (自動復帰)
| 記号 | 部品番号 | メーカー品番 | 仕様 | パッケージ | 在庫数 | 価格 | 用途 |
|------|----------|-------------|------|------------|--------|------|------|
| **PTC1** | **C883148** | **BSMD1812-110-16V** | **1.1A 16V** | 1812 | **11,029** | **$0.06** | +12V過負荷保護 |
| **PTC2** | **C883128** | **BSMD1206-075-16V** | **0.75A 16V** | 1206 | **51,532** | **$0.05** | +5V過負荷保護 |
| **PTC3** | **C883148** | **BSMD1812-110-16V** | **1.1A 16V** | 1812 | **11,029** | **$0.06** | -12V過負荷保護 ※ |

**※ PTC3注記**: 設計値0.9Aに対し1.1Aを使用。0.9A品は在庫なし。-12V実負荷800mAに対し十分な保護マージン。

#### ヒューズ (SMD・バックアップ保護)
| 記号 | 部品番号 | メーカー品番 | 仕様 | パッケージ | 在庫数 | 価格 | 用途 |
|------|----------|-------------|------|------------|--------|------|------|
| **F1** | **C5183824** | **6125FA2A** | **2A 250V** | 2410 (6.1x2.6mm) | **744** | **$0.40** | +12V短絡保護 |
...
1. ~~**部品確定・在庫最適化**~~: ✅ **完了!**
   - ✅ PTCリセッタブルヒューズ (C883148, C883128)
   - ✅ 2A SMDヒューズ (C5183824)
   - ✅ USB-PD IC: CH224D (在庫2,291) - 15V対応確認済み
   - ✅ リニアレギュレータ: 全て高在庫品に変更 (15万~27万個在庫)
